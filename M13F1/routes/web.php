...
Route::group(['middleware'=>['sess']], function(){
	...
	Route::get('/home/details/{id}', 'HomeController@show')->name('home.show')->middleware('sess');
		...
		Route::get('/home/edit/{id}', ['as'=>'home.edit1','uses'=>'HomeController@edit1']);
		Route::post('/home/edit/{id}', 'HomeController@update1');
		...
		Route::get('/home/delete/{id}', 'HomeController@delete1')->name('home.delete1');
		Route::post('/home/delete/{id}', 'HomeController@destroy1')->name('home.destroy1');
